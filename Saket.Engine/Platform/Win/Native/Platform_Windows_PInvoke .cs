...
namespace Saket.Engine.Platform.Win
{
    ...
    public class Platform_Windows_PInvoke
    {
        ...
        public static extern int GetMessage(out WindowMessage lpMsg, IntPtr hWnd, uint wMsgFilterMin,uint wMsgFilterMax);
        ...
        /// <returns></returns>
        [DllImport("user32.dll")]
        public static extern bool TranslateMessage([In] ref WindowMessage lpMsg);
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr DispatchMessage([In] ref WindowMessage lpmsg);
